module github.com/dperez4787/cosmo-router

go 1.25.0

// Pseudo-version pinned to the router@0.330.0 release tag
// (commit 6c2dc0f7b4e632ac0e5ca3c83342092492d05b77).
require (
	github.com/wundergraph/cosmo/router v0.0.0-20260708101558-6c2dc0f7b4e6
